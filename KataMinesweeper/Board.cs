...
namespace KataMinesweeper
{
    public class Board
    {
        ...
        public bool IsMine(int xCoordinate, int yCoordinate)
        {
            return _boardSquares[xCoordinate, yCoordinate].IsMine;
        }
        ...
        {
            return _boardSquares.Cast<Square>().Where(square => square.IsMine).ToList();
        }
        ...
        {
            return _boardSquares.Cast<Square>().Count(square => square.IsMine);
        }
